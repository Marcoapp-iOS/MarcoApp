...
let AvatarSquires = JSQMessagesAvatarImageFactory().avatarImage(withUserInitials: "QJ", backgroundColor: UIColor.gray, textColor: UIColor.white, font: UIFont.systemFont(ofSize: 12))
